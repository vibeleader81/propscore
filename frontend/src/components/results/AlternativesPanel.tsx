...
function AlternativeCard({ alt }: { alt: AlternativeSuburb }) {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(160deg, #173753 0%, #1b4353 100%)', border: '1px solid rgba(40,146,215,0.15)', boxShadow: '0 4px 20px rgba(23,55,83,0.3)' }}
    >
      {/* Header */}
      ...
      <div className="px-5 py-4 flex-1">
        <p className="text-xs leading-relaxed italic" style={{ color: '#6daedb' }}>{alt.rationale}</p>
      </div>
